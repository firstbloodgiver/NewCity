#pragma checksum "C:\Document\VSproject\NewCity\NewCity\Views\CreateStory\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c0b87dc869abc17ff2321baaa422a4cb87d2dab0"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c0b87dc869abc17ff2321baaa422a4cb87d2dab0", @"/Views/CreateStory/Index.cshtml")]
    ...
    public class Views_CreateStory_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<IEnumerable<NewCity.Models.StoryCard>>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8fb0188a27ae4aa5afbe186134bb3d47", async() => {
            }
            );
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c81fbc5ceefd4274a10160875b9eeec5", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
            ...
            <div class=""form-group"">
                ");
            EndContext();
            BeginContext(1005, 177, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c3ecb43c5ee248bb80b73f4c551b877e", async() => {
                BeginContext(1029, 146, true);
...
<div id=""ConditionModel"" class=""modal fade"">
    <div class=""modal-dialog"">
        <div class=""modal-content"">
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "af3815758d734b1a88137ae326ff2530", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_FormTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.FormTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_TagHelpers_FormTagHelper);
...
<div id=""EffectModel"" class=""modal fade"">
    <div class=""modal-dialog"">
        <div class=""modal-content"">
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "355256eed498452396ff9259b3bbc2c9", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_FormTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.FormTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_TagHelpers_FormTagHelper);
...
#line 98 "C:\Document\VSproject\NewCity\NewCity\Views\CreateStory\Index.cshtml"
             Write(Json.Serialize(Model.First()));

#line default
#line hidden
            EndContext();
            BeginContext(3163, 11557, true);
            WriteLiteral(@";
        CreaterView(CardObj)
    ...
    function NextCard(id, seriesid, optionid) {
        ...
        i");
            WriteLiteral(@"f (confirm(""即将移动到新的页面，请确认已保存"")) {
    ...
    function LoadNextCard(data) {
        ...
        let Img = ""<p>"" + img+""</p>"";
        let Content = ""<textarea name='storyCar");
            WriteLiteral(@"d.Text' class='form-control' rows='10' >"" + text +""</textarea>"";
        let Option = """";
        //计算当前是第几个选项
        ...
        for (let i in data.storyOptions) {
            ...
            option += ""<inpu");
            WriteLiteral(@"t name='storyCard.StoryOptions[""+i+""].ID' hidden type='text value="" + id+"" />"";
            ...
            option += ""<input id='storyCard.StoryOptions["" + i + ""].NextStoryCardI");
            WriteLiteral(@"D' name='storyCard.StoryOptions["" + i +""].NextStoryCardID' type='text' placeholder='为空则新建故事卡' value='""+NextStoryCardID+""'>""
    ...
    function CreateOption(i) {
        ...
        option += ""<button type='button' onclick='Condition("" + i + "")'>条件</button>""
        option += ""<button type='button' onclick='Effect("" ");
            WriteLiteral(@"+ i + "")'>效果</button>""
    ...
    function Condition(i) {
      ...
      ");
            WriteLiteral(@"          let Name = ""<input  type='text' name='Name' id='cd-storyStates["" + i + ""].Name'/>"";
              ...
              ");
            WriteLiteral(@"  document.getElementById(""cd-storyStates["" + i + ""].Type"").text = enumConditionType[condition[i][""Type""]];
    ...
    function Effect(number) {
        ...
        debugger;
        let ef = document.getElementBy");
            WriteLiteral(@"Id(""storyCard.StoryOptions["" + number + ""].Effect"").value;
        if (ef && ef!='/') {
    ...
    ");
            WriteLiteral(@"            $(""#EffectForm"").append(toappend)
                effectcount++;
                //赋值
                debugger;
    ...
    function AddEffect() {
        ...
        let Name = ""<input  type='text'  name='Name' id='ef-storyStates["" + i + ""].Name'/>"";
        let Type = """);
            WriteLiteral(@"<select  name='Type' id='ef-storyStates["" + i + ""].Type'>""
            + ""<option value='0'>增加</option>""
            + ""<option value='1'>减少</option>""
            + ""<option value='2'>赋值</option>""
            + ""</select>"";
    ...
    function S4() {
        return (((1 + Math.random(");
            WriteLiteral(@")) * 0x10000) | 0).toString(16).substring(1);
    }
    function guid() {
